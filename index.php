                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-5" style="font-weight: bolder">
                        <li class="nav-item">
                            <a class="nav-link" href="#Home"
                               onclick="closeNavbar()"><?php if ($_SESSION['lan'] == 'CN') echo '主頁'; else echo 'Home' ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#About"
                               onclick="closeNavbar()"><?php if ($_SESSION['lan'] == 'CN') echo '關於我們'; else echo 'About' ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Services"
                               onclick="closeNavbar()"><?php if ($_SESSION['lan'] == 'CN') echo '服務介紹'; else echo 'Services' ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Products"
                               onclick="closeNavbar()"><?php if ($_SESSION['lan'] == 'CN') echo '產品簡介'; else echo 'Products' ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"
                               onclick="closeNavbar()"><?php if ($_SESSION['lan'] == 'CN') echo '覆蓋範圍'; else echo 'Coverage' ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Contact"
                               onclick="closeNavbar()"><?php if ($_SESSION['lan'] == 'CN') echo '聯繫我們 '; else echo 'Contact' ?></a>
                        </li>
                    ...
                    <div class="swiper-slide">
                        <div class="main__banner__bg"
                            ...
                            <div class="container">
                                ...
                                <p class="fs-6 mb-5"
                                   style="text-align: justify"><?php if ($_SESSION['lan'] == 'CN') echo '我們的產品組合包括全面的船用燃料油和潤滑油，可滿足不同船舶和航運公司的需求。  '; else echo 'Our product portfolio includes a comprehensive range of marine fuels to meet the
                                            ...
                                            <div class="card-body">
                                                <div class="theme__content text-xl-start text-center mb-5 mb-lg-0">
                                                    ...
                                                    <p class="" style="text-align: justify">
                                                        <small> <?php if ($_SESSION['lan'] == 'CN') echo '這是加油駁船主要供應的產品。 它是各類船舶用作推進和發電能源的燃油。  '; else echo 'This is the primary
                                        ...
                                        <div class="card" style="height: <?php if ($_SESSION['lan'] == 'CN') echo '300px'; else echo '350px'; ?>;">
                                            <div class="card-body">
                                                <div class="theme__content text-xl-start text-center mb-5 mb-lg-0">
                                                    ...
                                                    <p class="" style="text-align: justify">
                                                        <small><br> <?php if ($_SESSION['lan'] == 'CN') echo '柴油是比燃油更乾淨的替代品。 它的硫含量較低，適用於需要更高品質燃料的船舶，例如在排放控制區域運作的船舶或具有更嚴格環境法規的船舶。'; else echo 'MGO is a lighter
                                                        and
                                        ...
                                        <div class="card" style="height: <?php if ($_SESSION['lan'] == 'CN') echo '300px'; else echo '350px'; ?>;">
                                            <div class="card-body">
                                                <div class="theme__content text-xl-start text-center mb-5 mb-lg-0">
                                                    ...
                                                    <p class="" style="text-align: justify">
                                                        <small> <?php if ($_SESSION['lan'] == 'CN') echo '我們提供一系列專為船舶應用設計的潤滑油。 這些潤滑劑有助於減少船舶引擎和機械的摩擦和磨損，確保平穩運作並延長關鍵零件的使用壽命。'; else echo ' We offer a range of
                ...
                <div class="row ">
                    <div class="col-lg-3 col-sm-12">
                        <div class="theme__content text-xl-start mb-5 mb-lg-0">
                            ...
                            <p class=""
                               style="text-align: justify"> <?php if ($_SESSION['lan'] == 'CN') echo '主要加油港：'; else echo 'Major Bunker Ports:' ?></p>
                        ...
                        <div class="theme__content text-xl-start mb-5 mt-5 mb-lg-0">
                            ...
                            <div class="quote__btn mt-2 mb-2">
                                <a href="assets/pdf/ABL%20Profile%20v23.1.pdf"
                                   target="_blank"
                                   class="ht_btn text-white"><span> <?php if ($_SESSION['lan'] == 'CN') echo '下載'; else echo 'Download' ?></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" name="fname"
                                               placeholder= <?php if ($_SESSION['lan'] == 'CN') echo '姓名'; else echo '"First Name"' ?> required>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" name="lname"
                                               placeholder= <?php if ($_SESSION['lan'] == 'CN') echo '姓名'; else echo '"Last Name"' ?> required>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="email" name="email"
                                               placeholder= <?php if ($_SESSION['lan'] == 'CN') echo '電郵'; else echo '"Email"' ?>  required>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" name="phone"
                                               placeholder= <?php if ($_SESSION['lan'] == 'CN') echo '電話'; else echo '"Contact Number"' ?> required>
                                    </div>
                                    <div class="col-md-12">
                                        <input name="message"
                                               placeholder= <?php if ($_SESSION['lan'] == 'CN') echo '查詢內容'; else echo '"Enquiry Details"' ?> required>
                                    </div>
                                    <div class="col-12">
                                        <button class="ht_btn hover-bg border-0" type="submit"
                                                name='contact_form'>  <?php if ($_SESSION['lan'] == 'CN') echo '傳訊息'; else echo 'Send Message' ?>
                                            <img
                    ...
                    <div class="row gx-lg-0">
                        ...
                        <div class="col-xxl-4 col-xl-2 col-lg-4 col-md-6">
                            <div class="footer__widget mb-30 ps-xxl-5 ">
                                ...
                                <p class="fs-6"
                                   style="    line-height: 25px;"><?php if ($_SESSION['lan'] == 'CN') echo '  <b>地址： </b> <br> 香港九龍荔枝角長沙灣道833號長沙灣廣場1座11樓1101室 '; else echo '  <b>Address : </b> <br> Room 1101, 11/F, Tower 1, Cheung Sha Wan Plaza, 833
                                        Cheung Sha
                                        Wan Road,
                                ...
                                <p class="fs-6"
                                   style="text-align: justify"><?php if ($_SESSION['lan'] == 'CN') echo ' <b>電子郵件 : </b> <br>sales@achievebunker.com'; else echo ' <b>Email : </b> <br>sales@achievebunker.com' ?>
